...
public class LineChart: UIView {
    ...
    */
    private class Helpers {
        ...
        * Lighten color.
        */
        private class func lightenUIColor(_ color: UIColor) -> UIColor {
            var h: CGFloat = 0
            var s: CGFloat = 0
            var b: CGFloat = 0
            var a: CGFloat = 0
     ...
     * Handle touch events.
     */
    private func handleTouchEvents(_ touches: NSSet!, event: UIEvent) {
...
public class LinearScale {
    ...
    private func interpolate(_ a: CGFloat, b: CGFloat) -> (c: CGFloat) -> CGFloat {
        var diff = b - a
    ...
    private func uninterpolate(_ a: CGFloat, b: CGFloat) -> (c: CGFloat) -> CGFloat {
        var diff = b - a
    ...
    private func bilinear(_ domain: [CGFloat], range: [CGFloat], uninterpolate: (a: CGFloat, b: CGFloat) -> (c: CGFloat) -> CGFloat, interpolate: (a: CGFloat, b: CGFloat) -> (c: CGFloat) -> CGFloat) -> (c: CGFloat) -> CGFloat {
